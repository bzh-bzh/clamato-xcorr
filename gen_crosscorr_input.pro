...
datadir = '/global/u1/b/bzh/clamato-xcorr/data/clamato_dr2/'
...
insp_fil =  datadir+'cl2020_valueadded_release_20200602.txt'
...
contfil = datadir+'contlya_musyc_allstack.dat'
...
openw, 19, datadir+'list_xcorr_input_2020_v0.txt'
...
FOR ii=0, nsel-1 DO BEGIN
   ...
   if qso[ii] EQ 1.0 then qsoflag = 1 else qsoflag = 0
...
openw, 11, datadir+'pixel_radecz_cl2020_v0.bin'
